...
const BannerSection1 = () => {
    return ( 
        <div className="flex items-center px-4 sm:px-16 bg-blue-900 w-full h-screen relative overflow-hidden select-none" style={{backgroundImage: 'url('+ Banner1 +')'}}>
            <h1 className="text-4xl sm:text-6xl font-bold text-white sm:max-w-[900px]">WISH YOU MANY MORE HAPPY RETURNS OF THE DAY <br /><span className="text-yellow-400 text-6xl sm:text-8xl">AFLALI</span></h1>

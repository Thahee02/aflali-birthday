    ...
    return ( 
        <div className='bg-blue-950 pb-12'>
            ...
            <div className='w-full flex justify-center items-center mt-10'>
                <Carousel responsive={responsive} infinite={true}  centerMode={false} autoPlay={true} autoPlaySpeed={7500} transitionDuration={1000} className='px-5'>               
                    <div className='w-96  border-2 rounded-xl text-white flex flex-col items-center py-5 px-4'>

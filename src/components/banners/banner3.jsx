    ...
    return ( 
        <div className='bg-blue-950 pb-12'>
            ...
            <div className='w-full flex justify-center items-center mt-10'>
                <Carousel responsive={responsive} infinite={true}  centerMode={false} autoPlay={true} autoPlaySpeed={7500} transitionDuration={1000} className='max-lg:px-14 max-xl:px-4 px-12'>               

...
const BannerSection2 = () => {
    return ( 
        <div className="w-full h-[400px] sm:h-[500px] md:h-[700px] xl:h-screen bg-yellow-600 select-none relative overflow-hidden">
            <img src={PhotoFrame} alt="" className='absolute top-14 xl:left-16 w-[1400px]' />
            <h1 className="text-center text-white text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold py-8 z-10">MEMORIES WITH "US🥰"</h1>
